...
# Blast
blastp_g1_g2 = 'blastp -query /data/genomes/"GCF_000007865.1_ASM786v1_genomic.fna" -subject /data/genomes/"GCF_000009445.1_ASM944v1_genomic.fna" -outfmt 6 > /data/results_blast/blastp_g1_g2.blast'
